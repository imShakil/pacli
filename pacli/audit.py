...
AUDIT_LOG_PATH: Path = Path.home() / ".config" / "pacli" / "audit.log"
...
class AuditEvent(str, Enum):
    """All auditable operations in pacli.
...
#:
#:     from pacli.audit import audit_log, AuditEvent
